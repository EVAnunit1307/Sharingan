...
if($LASTEXITCODE -ne 0 -or $navReport.failed -gt 0 -or $navReport.tests.Count -lt 59 -or @($navReport.tests | Where-Object state -ne 'Success').Count){throw "Tests failed or incomplete: $navEvidence"}
